...
def create_app(service: ChartApiService | None = None) -> FastAPI:
    ...
    def get_chart_window(
        ...
        as_of_bar_id: int | None = Query(default=None),
        as_of_event_id: str | None = Query(default=None),
        ...
        include_replay_sequence: bool = Query(default=False),
        data_version: str | None = Query(default=None),
        structure_source: StructureSourceProfile = Query(default="auto"),
        ...
        try:
            return chart_service.get_chart_window(
                ...
                include_replay_sequence=include_replay_sequence,
    ...
    def get_structure_detail(
        ...
        as_of_bar_id: int | None = Query(default=None),
        as_of_event_id: str | None = Query(default=None),
        left_bars: int = Query(default=0, ge=0),
        right_bars: int = Query(default=0, ge=0),
        buffer_bars: int = Query(default=0, ge=0),
        data_version: str | None = Query(default=None),
        structure_source: StructureSourceProfile = Query(default="auto"),
        feature_version: str | None = Query(default=None),
        feature_params_hash: str | None = Query(default=None),
